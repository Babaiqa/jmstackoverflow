...
import com.javamentor.qa.platform.dao.impl.model.UserFavoriteQuestionDao;
...
public class UserFavoriteQuestionService extends ReadWriteServiceImpl<UserFavoriteQuestion, Long>{
    public UserFavoriteQuestionService(UserFavoriteQuestionDao userFavoriteQuestionDao) {
