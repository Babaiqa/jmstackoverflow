...
public class QuestionCreateDto implements Serializable {
    ...
    @NotNull(groups = OnCreate.class, message = "Значение title должно быть заполнено")
    private String title;
    @NotNull(groups = OnCreate.class, message = "Значение userId должно быть заполнено")
    private Long userId;
    @NotNull(groups = OnCreate.class, message = "Значение description должно быть заполнено")
